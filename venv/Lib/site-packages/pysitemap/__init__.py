...
def crawler(root_url, kw, out_file, out_format='xml', maxtasks=100, exclude_urls=None):
    """
    run crowler
    ...
    c = Crawler(root_url, kw, out_file=out_file, out_format=out_format, maxtasks=maxtasks)
    if exclude_urls:
