...
from database import insertKeyword_url
...
class Crawler:
    ...
    def __init__(self, rooturl, kw, out_file, out_format='xml', maxtasks=100,
    ...
    async def process(self, url):
        ...
        if bool(s.find(text=re.compile(self.kw))):
            insertKeyword_url(self.kw, url)
